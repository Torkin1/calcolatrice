...
public class OnSub extends State {
	...
	public void onEqButtonClick() {
		...
		Controller.getReference().setPrevNumber(String.valueOf(Controller.getReference().doSub(Float.parseFloat(Controller.getReference().getPrevNumber()), Float.parseFloat(Controller.getReference().getNumber()))));
