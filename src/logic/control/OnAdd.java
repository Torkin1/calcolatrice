...
public class OnAdd extends State{
	...
	public void onEqButtonClick() {
		...
		Controller.getReference().setPrevNumber(String.valueOf(Controller.getReference().doAdd(Float.parseFloat(Controller.getReference().getPrevNumber()), Float.parseFloat(Controller.getReference().getNumber()))));
